from trmnl_digital_product_sales import collector
import unittest
from unittest.mock import patch
from trmnl_digital_product_sales.common import ConfigurationError, NoRedirect, clock, packet, push, request
...
class BoundaryTests(unittest.TestCase):
    def test_demo_fits_and_cannot_be_published(self):
        ...
        with patch("trmnl_digital_product_sales.common.request") as network:
